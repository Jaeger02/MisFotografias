...
public class MainActivity extends AppCompatActivity {
        ...
        binding.btnUpload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (photoSelectedUri == null) {
                    Snackbar.make(binding.container, R.string.main_message_url_null, BaseTransientBottomBar.LENGTH_LONG).show();
                    return;
                }
                ...
                photoReference.putFile(photoSelectedUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Snackbar.make(binding.container, R.string.main_message_upload_error, BaseTransientBottomBar.LENGTH_LONG);
                    }
                });
            }
        });
    ...
    private File createImageFile() {
        final String timeStamp = new SimpleDateFormat("dd-MM-yyyy-_HHmmss", Locale.ROOT)
                .format(new Date());
